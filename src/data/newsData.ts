...
export const newsData: NewsItem[] = [
  ...
  },
  {
    ...
    source: "시민일보",
    content:
      "한평생그룹이 교육컨설팅 브랜드 '에듀바이저스'를 출범시켜 커리어 설계 중심의 교육 서비스를 강화할 예정이다.",
  },
  {
    id: "6",
    title:
      "한평생그룹, '에듀바이저스' 공식 출범… 교육서비스에 커리어 컨설팅 접목",
    date: "2024.07.23",
    link: "https://www.siminilbo.co.kr/news/newsview.php?ncode=1160287540055868",
    thumbnail: "/images/main/news6.jpg",
    source: "시민일보",
    content:
      "한평생그룹이 '에듀바이저스'를 공식 출범시켜 교육 서비스에 커리어 컨설팅을 접목한 새로운 서비스를 제공한다.",
  },
  {
    id: "7",
    title:
      "한평생그룹 에듀바이저스, 수강생 등록 데이터 분석 결과 발표… 50대가 가장 많이 선택한 자격증은 ‘사회복지사’",
    date: "2024.08.13",
