...
export const metadata: Metadata = {
  title: "사업영역 | 한평생교육그룹",
  description: "한평생교육그룹의 핵심 사업영역인 교육컨설팅, 인사컨설팅, ESG 컨설팅, 교육훈련 서비스를 소개합니다.",
  keywords: "교육컨설팅, 인사컨설팅, ESG컨설팅, 교육훈련, 기업교육, 평생교육, 한평생교육그룹",
  openGraph: {
    title: "사업영역 | 한평생교육그룹",
    description: "한평생교육그룹의 핵심 사업영역인 교육컨설팅, 인사컨설팅, ESG 컨설팅, 교육훈련 서비스를 소개합니다.",
  ...
  alternates: {
    canonical: "https://korhrd.com/business",
  },
};
