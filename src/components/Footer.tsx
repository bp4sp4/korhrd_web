        ...
        <div className={styles.footerTop}>
          <div className={styles.footerMain}>
            <div className={styles.brandContainer}>
              <img src="/logo2.png" alt="한평생교육그룹 로고" className={styles.logo} />
              <h2 className={styles.brandName}>한평생 교육그룹</h2>
            </div>
            <div className={styles.companyInfo}>
                <p>대표이사 : 양병웅 | 사업자등록번호 : 227-88-03196 | 원격평생교육시설신고 (제 원격20-6호)</p>
                <p>주소 : 서울시 방학로 174, 4층 | 개인정보관리책임자 : 유현모</p>
                <p>이메일 : korhrdpartners@naver.com</p>
            </div>
          </div>
          <div className={styles.familySiteContainer}>
            <select className={styles.familySiteSelect} onChange={handleFamilySiteChange}>
